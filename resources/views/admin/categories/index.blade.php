    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="overflow-x-auto">
            <form action="{{ route('admin.categories.index') }}" method="GET" class="mb-4 flex gap-2 py-2">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Buscar categoría..." class="px-4 py-2 border rounded-lg shadow-sm w-full outline-none focus:ring-2 focus:ring-pink-400">
