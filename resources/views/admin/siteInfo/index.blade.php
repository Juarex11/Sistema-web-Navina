...
<main class="px-8 py-7 flex flex-col flex-1 overflow-y-auto">
    ...
    <h1 class="text-5xl font-semibold text-neutral-800 pb-5 font-[Great_Vibes]">Informacion de la empresa</h1>
    ...
    <div class="gap-7 lg:grid lg:grid-cols-2">
        ...
        <form class="flex flex-col gap-3"
            ...
            <p class="text-4xl  font-[Great_Vibes]">Localizacion</p>
            ...
            <p class="text-4xl  font-[Great_Vibes]">Telefono</p>
            <input name="telefono"
                value="{{ old('telefono', $info->telefono ?? '') }}"
                class="border-[1.5px] p-2 text-sm rounded-xl border-neutral-400"
                required>

            <p class="text-4xl  font-[Great_Vibes]">Correo</p>
            <input name="correo"
                value="{{ old('correo', $info->correo ?? '') }}"
                class="border-[1.5px] p-2 text-sm rounded-xl border-neutral-400"
                required>

            <p class="text-4xl  font-[Great_Vibes]">Horario de Atención</p>
            <input name="horario"
        ...
        <div class="flex-1 flex">
            ...
            flex flex-col justify-center items-center text-center">
                @if($info)
                <h1 class="text-6xl font-bold font-[Great_Vibes] mb-2"> {{ $info->localizacion }}</h1>
                <p> {{ $info->telefono }}</p>
                <p> {{ $info->correo }}</p>
                <p> {{ $info->horario }}</p>
                @endif
