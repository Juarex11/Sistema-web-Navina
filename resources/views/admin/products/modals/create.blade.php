                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class=" overflow-hidden">
                            ...
                            <div class="mb-1">
                                ...
                                <input class="w-full px-3 py-1 rounded-lg border border-gray-300 outline-none focus:ring-2 focus:ring-pink-300" type="text" name="sub_category" placeholder="Nombre de la subcategoría">
                            </div>
                            <div class="mb-1">
                                <label class="block mb-1 font-medium text-gray-700">
                                    Estado:
