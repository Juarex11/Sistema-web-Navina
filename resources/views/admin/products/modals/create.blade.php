<div x-show="createOpen" x-cloak x-transition class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
    <div @click.outside="closeCreate()" class="bg-white rounded-xl shadow-xl w-full max-w-3xl p-6">
                ...
                <div class=" overflow-hidden">
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-1">
                        ...
                        <div>
                            ...
                            <input
                                class="w-full px-3 py-1 rounded-lg border border-gray-300 outline-none focus:ring-2 focus:ring-pink-300"
                                type="number" name="discount" step="1" min="0" max="100" required>
                        </div>
                    ...
                    <div class="mb-1">
                        ...
                        <textarea
                            class="w-full px-3 py-1 rounded-lg border border-gray-300 outline-none focus:ring-2 focus:ring-pink-300"
                            name="use_mode" placeholder="Casos de uso del producto"></textarea>
                    </div>
                </div>
                {{-- Columna derecha --}}
                <div class="">
