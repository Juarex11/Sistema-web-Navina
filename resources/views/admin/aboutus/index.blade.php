...
<main class="px-8 py-7 flex flex-col flex-1 overflow-y-auto">
  ...
  <h1 class="text-5xl font-semibold text-neutral-800 pb-5 font-greatVibes">Mision y Vision</h1>
  ...
  <div class="gap-7 lg:grid lg:grid-cols-2">
    ...
    <form class="flex flex-col text-neutral-700"
      ...
      <label class="text-4xl font-medium font-greatVibes">Mision</label>
      ...
      <label class="text-4xl font-medium font-greatVibes pt-4">Vision</label>
    ...
    text-neutral-700 font-mulish">
      ...
      <h1 class="text-5xl font-greatVibes text-center  font-semibold text-neutral-800 ">Vista Previa</h1>

      <article class="p-4 flex flex-col gap-2 rounded-lg shadow-md bg-white">
        <h1 class="text-3xl font-semibold text-neutral-900 font-greatVibes">Mision</h1>
        <p class="text-sm">
      ...
      <article class="p-4 flex flex-col gap-2 rounded-lg shadow-md bg-white">
        <h1 class="text-3xl font-semibold text-neutral-900 font-greatVibes">Vision</h1>
        <p class="text-sm">
