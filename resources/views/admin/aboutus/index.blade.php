...
<main class="px-8 py-7 flex flex-col flex-1 overflow-y-auto">
  ...
  <h1 class="text-5xl font-semibold text-neutral-800 pb-5 font-[Great_Vibes]">Mision y Vision</h1>
  ...
  <div class="gap-7 lg:grid lg:grid-cols-2">
    ...
    <form class="flex flex-col gap-4 text-neutral-700"
      ...
      <label class="text-4xl font-medium font-[Great_Vibes]">Mision</label>
      ...
      <label class="text-4xl font-medium font-[Great_Vibes]">Vision</label>
    ...
    text-neutral-700 font-mulish">
      ...
      <article class="p-4 flex flex-col gap-2 rounded-lg shadow-md bg-white">
        <h1 class="text-4xl font-semibold font-[Great_Vibes] text-neutral-900">Mision</h1>
        <p class="text-sm">
      ...
      <article class="p-4 flex flex-col gap-2 rounded-lg shadow-md bg-white">
        <h1 class="text-4xl font-semibold font-[Great_Vibes] text-neutral-900">Vision</h1>
        <p class="text-sm">
