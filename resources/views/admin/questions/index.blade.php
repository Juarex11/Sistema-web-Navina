      ...
      <div class="flex justify-between items-center">
        <div>
          <h3 class="text-2xl font-bold text-gray-900 flex items-center">
            ...
            Gestión de questions Frecuentes
          </h3>
          <p class="text-sm mt-1 text-gray-600">Administra las questions y respuestas para tus clientes</p>
        </div>
    ...
    <div class="p-6">
      <div class="overflow-x-auto">
        <table class="min-w-full">
          <thead class="bg-linear-to-r from-primary to-primary-dark text-black">
            <tr>
              <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">
                <i class="fas fa-hashtag mr-2"></i>Orden
              </th>
              <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">
                <i class="fas fa-question mr-2"></i>question
              </th>
              <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">
