      ...
      <form method="POST" action="{{ route('admin.questions.store') }}" class="space-y-6">
        ...
        <div>
          ...
          <textarea name="pregunta"
            id="pregunta"
            rows="3"
            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors duration-150"
            required
        ...
        <div class="flex justify-between pt-6 border-t border-gray-200">
          ...
          <button type="submit"
            class="bg-linear-to-r from-pink-500 to-pink-600 text-white px-6 py-2 rounded-lg hover:from-pink-600 hover:to-pink-700 transition-all duration-200 shadow-md hover:shadow-lg">
