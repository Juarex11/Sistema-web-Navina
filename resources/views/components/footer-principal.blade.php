...
<div class="flex flex-col md:flex-row justify-center items-center w-full gap-2 pt-16 pb-7 text-4xl font-bold">
    ...
    {{-- Comentarios --}}
    <div x-data="{ page: 0 }" class="max-w-6xl mx-auto mb-16">
        <div class="overflow-hidden">
            <div class="flex transition-transform duration-500"
                :style="'transform: translateX(-' + (page * 100) + '%)'">
                @foreach($comments->chunk(3) as $group)
        ...
        <div class="flex justify-center gap-3 mt-6">
            <template x-for="i in {{ ceil($comments->count()/3) }}">
                <button
                    @click="page = i-1"
