  ...
  <section class="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-7xl mx-auto text-center">
    ...
    <div class="">
      ...
      <article class="w-full min-h-72 bg-white rounded-2xl p-4 border-1.5 border-neutral-200 shadow-lg">
        ...
        <p class="my-2 mx-6 text-gray-600">
        ...
        <div class="w-14 h-14 mx-auto rounded-full bg-white flex items-center justify-center">
          <svg class="w-9 h-9" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" viewBox="0 0 30 30" version="1.1" id="svg822" inkscape:version="0.92.4 (f8dce91, 2019-08-02)" sodipodi:docname="email.svg" fill="#000000" stroke="#000000">
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <sodipodi:namedview id="base" pagecolor="#ffffff" bordercolor="#666666" borderopacity="1.0" inkscape:pageopacity="0.0" inkscape:pageshadow="2" inkscape:zoom="17.833333" inkscape:cx="15" inkscape:cy="10.99181" inkscape:document-units="px" inkscape:current-layer="layer1" showgrid="true" units="px" inkscape:window-width="1366" inkscape:window-height="713" inkscape:window-x="0" inkscape:window-y="0" inkscape:window-maximized="1" showguides="false">
              ...
              <g inkscape:label="Layer 1" inkscape:groupmode="layer" id="layer1" transform="translate(0,-289.0625)">
                <path style="opacity:1;fill:#fb64b6;fill-opacity:1;stroke:none;stroke-width:0.49999997;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1" d="M 5 5 C 4.2955948 5 3.6803238 5.3628126 3.3242188 5.9101562 L 14.292969 16.878906 C 14.696939 17.282876 15.303061 17.282876 15.707031 16.878906 L 26.675781 5.9101562 C 26.319676 5.3628126 25.704405 5 25 5 L 5 5 z M 3 8.4140625 L 3 23 C 3 24.108 3.892 25 5 25 L 25 25 C 26.108 25 27 24.108 27 23 L 27 8.4140625 L 17.121094 18.292969 C 15.958108 19.455959 14.041892 19.455959 12.878906 18.292969 L 3 8.4140625 z " transform="translate(0,289.0625)" id="rect4592"></path>
              </g>
            </g>
          </svg>
        </div>
    ...
    <!-- Formulario -->
    <div class="w-full h-auto bg-white rounded-2xl border-1.5 border-neutral-200 shadow-lg">
      <div class="p-4 sm:p-6 md:p-8">
        <p class="font-extrabold text-2xl sm:text-3xl mb-4 mt-2 text-gray-800 text-start">
          Envíanos un mensaje
        </p>
        ...
        <form
          class="grid grid-cols-1 sm:grid-cols-2 gap-4 [&_input]:bg-gray-50 [&_input]:rounded-2xl [&_input]:border
          [&_input]:border-gray-300 [&_input]:p-4 [&_input]:placeholder:text-gray-400
          ...
          <input type="email" name="email" placeholder="Correo" class="col-span-1 sm:col-span-2" required>

          <input type="text" pattern="[0-9]{9}" maxlength="9" name="phone" placeholder="Teléfono" required>
          <input type="text" name="district" placeholder="Distrito" required>

          <textarea
            name="message"
            class="col-span-1 sm:col-span-2 min-h-36 bg-gray-50 rounded-2xl border border-gray-300 p-3 placeholder:text-gray-400
          ...
          <button
            type="submit"
            class="w-full bg-linear-to-r from-pink-500 to-purple-500 text-white font-bold py-4 sm:py-5 px-6 rounded-2xl col-span-1 sm:col-span-2">
            Enviar mensaje
          </button>
