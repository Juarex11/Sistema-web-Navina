      ...
      <div class="mt-7 grid grid-cols-2 gap-4 text-white">
        ...
        @php
            $message = urlencode(
                ...
                "Precio: S/ " . number_format($product->final_price, 2) . "\n\n" .
                "Me gustaría recibir más información."
            );
        @endphp

        <a
            href="https://wa.me/{{ '51' . ($siteInfo->telefono ?? '') }}?text={{ $message }}"
            target="_blank"
            rel="noopener noreferrer"
            class="flex gap-2 items-center justify-center transition-all py-3 px-6 rounded-lg font-semibold 
