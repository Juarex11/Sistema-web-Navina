<div class="fixed left-2 bottom-2 transition-all flex flex-col gap-3 duration-500 ease-in-out z-20"
  id="btnUI">

  <!-- Facebook -->
  <a class="p-3 xl:p-4 rounded-full bg-blue-600 hover:bg-blue-500"
  ...
  <!-- Instagram -->
  <a class="p-3 xl:p-4 rounded-full bg-linear-to-tr from-orange-400 to-pink-700
    hover:bg-linear-to-tr hover:from-orange-300 hover:to-pink-600"
    href="https://www.instagram.com/navi_natubelleza" target="_blank">

    <svg viewBox="0 0 24 24" fill="currentColor"
      class="size-6 xl:size-8 text-white transition-colors duration-80 xmlns="
  ...
  <!-- Tiktok -->
  <a class="p-3 xl:p-4 rounded-full bg-linear-to-tr bg-black hover:bg-gray-900"
...
<div class="fixed bottom-2 right-2 z-20">
  ...
  <div class="relative group">
    ...
    <span class="absolute bottom-1 right-17 bg-white text-sm px-3 py-1 rounded opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200 w-52 shadow xl:right-20">
      ¿Buscas productos naturales de calidad? ¡Chatea con nosotros ahora!
    </span>

    <a class="p-3 xl:p-4 rounded-full bg-green-500 hover:bg-green-400 flex items-center justify-center transform hover:scale-110 transition-all duration-100 ease-in-out"
