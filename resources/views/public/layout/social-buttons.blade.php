<div id="btnUI" class="fixed transition-all duration-500 ease-in-out z-20">
  <div class="fixed bottom-4 right-4">
    <a class="md:size-14 xl:size-18 size-11 rounded-full bg-green-500 hover:bg-green-400 flex items-center justify-center transform hover:scale-110 transition-all duration-100 ease-in-out group"
      ...
      target="_blank">
      <!-- tooltip -->
      <span class="absolute right-19 bg-white text-sm px-3 py-1 rounded opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200 w-52 shadow">
        ¿Buscas productos naturales de calidad? ¡Chatea con nosotros ahora!
      </span>

      <svg class="size-6 xl:size-8 text-white transition-colors duration-100 xmlns="
  ...
  <div class="fixed md:bottom-44 bottom-32 left-4">
    <a class="md:size-14 xl:size-18 size-11 rounded-full bg-blue-600 hover:bg-blue-500 flex items-center justify-center transform hover:scale-110 transition-all duration-100 ease-in-out group"
      ...
      <svg class="size-6 xl:size-8 text-white transition-colors duration-100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" viewBox="-5 0 20 20">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
  ...
  <div class="fixed md:bottom-24 bottom-18 left-4">
    <a class="md:size-14 xl:size-18 size-11 rounded-full bg-linear-to-tr from-orange-400 to-pink-700
    hover:bg-linear-to-tr hover:from-orange-300 hover:to-pink-600 flex items-center justify-center
    transform hover:scale-110 transition-all duration-100 ease-in-out group"
      href="https://www.instagram.com/navi_natubelleza" target="_blank">

      <svg viewBox="0 0 24 24" fill="currentColor"
        class="w-6 h-6 text-white
                transition-colors duration-80 xmlns=" http:"//www.w3.org/2000/svg">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
  ...
  <div class="fixed bottom-4 left-4">
    <a class="md:size-14 xl:size-18 size-11 rounded-full bg-black hover:bg-gray-900 flex items-center justify-center
    transform hover:scale-110 transition-all duration-100 ease-in-out group"
      href="https://www.tiktok.com/@natubellezanavi26" target="_blank">
      <svg class="size-6 xl:size-8 text-white transition-colors duration-100" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
          <title>tiktok</title>
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          btnUI.classList.add("opacity-0", "pointer-events-none");
        } else {
          btnUI.classList.remove("opacity-0", "pointer-events-none");
        }
      });
    });
