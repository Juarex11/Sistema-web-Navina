...
id="categories">
  ...
  <div class="grid grid-cols-3 gap-10">
    ...
    <article class="p-5 rounded-xl shadow-md overflow-hidden border border-gray-300 flex flex-col items-center text-center">
    ...
    <article class="rounded-xl shadow-md overflow-hidden border border-gray-300 flex flex-col items-center text-center p-5">
