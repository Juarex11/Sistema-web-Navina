<section class="grid grid-cols-2 md:grid-cols-4 gap-14 text-center"
  ...
  <div class="flex flex-col items-center gap-2 text-center py-4">
    ...
    <p class="font-bold text-neutral-600">Productos Naturales</p>
  </div>
  ...
  <div class="flex flex-col items-center gap-2 text-center py-4">
    ...
    <p class="font-bold text-neutral-600">Envío gratis</p>
  </div>
  ...
  <div class="flex flex-col items-center gap-2 text-center py-4">
    ...
    <p class="font-bold text-neutral-600">Garantía de calidad</p>
  </div>
  ...
  <div class="flex flex-col items-center gap-2 text-center py-4">
    ...
    <p class="font-bold text-neutral-600">Atención personalizada</p>
  </div>
