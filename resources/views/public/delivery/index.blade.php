...
<div class="px-5 py-8 mx-20 max-w-275 xl:mx-auto">
  ...
  <div class="flex items-start gap-2 mb-3">
    ...
    <svg viewBox="0 0 24 24" fill="none" class="md:w-9 md:h-9  w-8 h-8" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
      <g id="SVGRepo_iconCarrier">
        <path d="M4.5 5H18.2768C19.0446 5 19.526 5.82948 19.1451 6.49614L16.5758 10.9923C16.2198 11.6154 15.5571 12 14.8394 12H8M8 12L6.45625 14.47C6.03997 15.136 6.51881 16 7.30425 16H18M8 12L4.05279 4.10557C3.714 3.428 3.02148 3 2.26393 3H2M8 20C8 20.5523 7.55228 21 7 21C6.44772 21 6 20.5523 6 20C6 19.4477 6.44772 19 7 19C7.55228 19 8 19.4477 8 20ZM18 20C18 20.5523 17.5523 21 17 21C16.4477 21 16 20.5523 16 20C16 19.4477 16.4477 19 17 19C17.5523 19 18 19.4477 18 20Z" stroke="#f472b6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
      </g>
    </svg>
  </div>
  ...
  <div class="flex items-start gap-2 mb-3">
    ...
    <svg viewBox="0 0 24 24" fill="none" class="md:w-9 md:h-9  w-8 h-8" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path d="M8.5 12.5L10.5 14.5L15.5 9.5" stroke="#f472b6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
      </g>
    </svg>
  </div>
