            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-600">Modifica la información de la pregunta frecuente</p>
                    </div>

                    <form method="POST" action="{{ route('preguntas-frecuentes.update', $preguntaFrecuente->id) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <textarea name="pregunta" 
                                      ...
                                      required
                                      placeholder="Escribe la pregunta del cliente...">{{ old('pregunta', $preguntaFrecuente->pregunta) }}</textarea>
                            @error('pregunta')
                        ...
                        <div>
                            ...
                            <textarea name="respuesta" 
                                      ...
                                      required
                                      placeholder="Escribe la respuesta detallada...">{{ old('respuesta', $preguntaFrecuente->respuesta) }}</textarea>
                            @error('respuesta')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" 
                                       name="orden" 
                                       id="orden" 
                                       value="{{ old('orden', $preguntaFrecuente->orden) }}"
                                       min="0"
                            ...
                            <div>
                                ...
                                <div class="flex items-center h-10">
                                    <input type="checkbox" 
                                           ...
                                           id="activo" 
                                           value="1"
                                           {{ old('activo', $preguntaFrecuente->activo) ? 'checked' : '' }}
                        ...
                        <div class="flex justify-between pt-6 border-t border-gray-200">
                            <a href="{{ route('preguntas-frecuentes.index') }}" 
